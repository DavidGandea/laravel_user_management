...
<center><h1><div class="panel-heading">Update user</div></h1> </center>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('utilizators.update', ['id' => $user->id]) }}">
